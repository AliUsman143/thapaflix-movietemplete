  ...
  return (
    <>
      <footer class="text-gray-200  bg-gray-900 body-font">
        <div class=" mt-7">
          <div class="container px-5 py-10 p-4 mx-auto flex items-center sm:flex-row flex-col">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
              ...
              <span class="ml-3 text-white text-xl">Thapa Technology</span>
            </a>
          
            <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
              <a class="text-gray-500 border[1px]  border-white bg-white rounded-full p-2 hover:text-blue-600 hover:scale-125 duration-700">
                <svg
                  fill="currentColor"
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <a class="ml-3 text-gray-500 border[1px]  border-white bg-white rounded-full p-2 hover:text-blue-600 hover:scale-125 duration-700">
                <svg
                  fill="currentColor"
                  stroke-linecap="round"
                  stroke-linejoin="round"
